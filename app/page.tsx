export default function Home() {
  return (
    ...
    >
      <h1 style={{ fontSize: "3rem", marginBottom: "12px" }}>Momentia 💖</h1>
      ...
      <div style={{ display: "grid", gap: "20px", maxWidth: "500px", width: "100%" }}>
        <div
          style={{
        ...
        >
          <h2 style={{ fontSize: "1.5rem", marginBottom: "8px" }}>Basic — $3</h2>
        ...
        >
          <h2 style={{ fontSize: "1.5rem", marginBottom: "8px" }}>Premium — $5</h2>
          <p style={{ marginBottom: "16px" }}>
